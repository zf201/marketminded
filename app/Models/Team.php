...
#[Fillable(['name', 'slug', 'is_personal', 'ai_api_key', 'ai_provider', 'ai_api_url', 'fast_model', 'powerful_model', 'web_search_provider', 'brave_api_key', 'countries', 'homepage_url', 'blog_url', 'brand_description', 'product_urls', 'competitor_urls', 'style_reference_urls', 'target_audience', 'tone_keywords', 'calendar_steer', 'content_language'])]
