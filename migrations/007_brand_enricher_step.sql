...
-- Rebuild pipeline_steps to add brand_enricher to step_type CHECK
CREATE TABLE pipeline_steps_new (
    id INTEGER PRIMARY KEY,
    pipeline_run_id INTEGER NOT NULL REFERENCES pipeline_runs(id) ON DELETE CASCADE,
    step_type TEXT NOT NULL CHECK(step_type IN ('research','brand_enricher','factcheck','write','plan_waterfall')),
...
INSERT INTO pipeline_steps_new SELECT * FROM pipeline_steps WHERE step_type != 'brand_enricher';
