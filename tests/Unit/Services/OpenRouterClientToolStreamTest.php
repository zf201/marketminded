...
test('streamChatWithTools handles fetch_url tool call', function () {
    ...
    $result = $client->streamChatWithTools('System prompt', [['role' => 'user', 'content' => 'Read example.com']], [
...
test('streamChatWithTools passes through text-only stream', function () {
    ...
    $result = $client->streamChatWithTools('System', [['role' => 'user', 'content' => 'Hi']]);
...
test('streamChatWithTools uses custom tool executor', function () {
    ...
    $result = $client->streamChatWithTools('System', [['role' => 'user', 'content' => 'Update']], [], $executor);
